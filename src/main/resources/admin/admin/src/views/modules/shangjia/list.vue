        ...
        <div v-if="showFlag">
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="营业执照"
                                     header-align="center"
                                     width="200"
                                     label="营业执照">
                        <template slot-scope="scope">
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="身份证"
                                     header-align="center"
                                     width="200"
                                     label="身份证">
                        <template slot-scope="scope">
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('shangjia','查看') && contents.tableBtnIcon == 0" type="success"
                            ...
                            <el-button v-if="isAuth('shangjia','修改') && contents.tableBtnIcon == 0" type="primary"
                            ...
                            <el-button v-if="isAuth('shangjia','删除') && contents.tableBtnIcon == 0" type="danger"
