...
public class OrdersController {
    ...
    public R add(@RequestBody OrdersEntity orders, HttpServletRequest request){
        ...
        ShangpinxinxiEntity shangpinxinxiEntity = shangpinxinxiService.selectById(orders.getGoodid());
			// 检查商品库存是否充足
        if (shangpinxinxiEntity.getSpsl()<orders.getBuynumber()){
            return R.error("商品库存不足");
        }
			// 更新商品的销量和库存数量
        shangpinxinxiEntity.setXiaoliang(shangpinxinxiEntity.getXiaoliang()+orders.getBuynumber());
        shangpinxinxiEntity.setSpsl(shangpinxinxiEntity.getSpsl()-orders.getBuynumber());
