...
public class DiscussshangpinxinxiController { // 通过Spring的自动注入功能，注入商品信息评论表服务
    @Autowired
    ...
    /**
     * 后端详情 提供单个商品信息评论的详细信息
     */
    @RequestMapping("/info/{id}")
    public R info(@PathVariable("id") Long id){
			// 调用服务层的方法，根据ID获取商品信息评论实体
    ...
    public R delete(@RequestBody Long[] ids){
			// 调用服务层的方法，传入要删除的ID数组的列表形式，批量删除记录
