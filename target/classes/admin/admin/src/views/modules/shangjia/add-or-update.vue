<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="商家名" prop="yonghuming">
                        <el-input v-model="ruleForm.yonghuming"
                                  placeholder="商家名" clearable :readonly="ro.yonghuming"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="商家名" prop="yonghuming">
                            <el-input v-model="ruleForm.yonghuming"
                                      placeholder="商家名" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
              ...
              <el-col :span="12">
                <el-form-item class="select" v-if="type!='info'" label="审核" prop="sfsh">
                  <el-select v-model="ruleForm.sfsh" placeholder="是否通过">
                    <el-option
                ...
                <div v-else>
                  <el-form-item class="input" label="审核" prop="sfsh">
