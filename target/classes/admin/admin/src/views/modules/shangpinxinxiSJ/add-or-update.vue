    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
                            <img style="margin-right:20px;" v-bind:key="index"
                                 v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100"
                                 height="100">
                        </el-form-item>
                    </div>
                </el-col>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="是否允许议价" prop="sfyxyj">
                        <el-input v-model="ruleForm.sfyxyj"
                                  placeholder="是否允许议价" clearable :readonly="ro.sfyxyj"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="是否允许议价" prop=" sfyxyj
                        ">
                        <el-input v-model="ruleForm.sfyxyj"
                                  placeholder="是否允许议价" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="商品数量" prop="spsl">
                        <el-input v-model="ruleForm.spsl"
                                  placeholder="商品数量" clearable :readonly="ro.spsl"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="商品数量" prop=" spsl
                        ">
                        <el-input v-model="ruleForm.spsl"
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="新旧程度" prop="xjcd">
                        <el-input v-model="ruleForm.xjcd"
                                  placeholder="新旧程度" clearable :readonly="ro.xjcd"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="新旧程度" prop="xjcd">
                        <el-input v-model="ruleForm.xjcd"
            ...
            init(id, type) {
                if (this.$storage.get('Token')) {
                    this.$http({
                        ...
                        this.ruleForm.sjid = data.data.id
                    });
                }
