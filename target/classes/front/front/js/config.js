...
var adminurl = "http://localhost:9999/springboot4r3y8/admin/dist/index.html";
...
var menu = [{
    "backMenu": [{
        ...
        }, {"buttons": ["查看", "修改", "删除"], "menu": "已发货订单", "tableName": "orders/已发货"}, {
            "buttons": ["查看", "修改", "删除"],
            "menu": "未支付订单",
    ...
    "backMenu": [{
        ...
        "child": [{"buttons": ["查看", "删除"], "menu": "已支付订单", "tableName": "orders/已支付"}, {
            "buttons": ["查看", "删除"],
            "menu": "已退款订单",
